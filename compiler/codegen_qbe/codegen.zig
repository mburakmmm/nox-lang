...
pub const Codegen = struct {
    ...
    pub const isSpawnRefcountedType = ownership.isSpawnRefcountedType;
    pub const retainNonArcValue = ownership.retainNonArcValue;
    pub const releaseNonArcIfTemporary = ownership.releaseNonArcIfTemporary;
